...
import com.example.bluetoothchatapp.presentation.components.ChatScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            BluetoothChatAppTheme {
                ...
                LaunchedEffect(key1 = state.errorMessage) {// is triggered every time error message state changes (!)
